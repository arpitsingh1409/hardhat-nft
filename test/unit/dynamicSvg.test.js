//Tests are completed, but some functional implementations, such as coding for "getPriceFeed" function in Smart Contract is still left. Please consider them undone till the time the smart contracts are updated!"
  ...
  : describe("Dynamic SVG NFT Unit Tests", function () {
      ...
      describe("mintNft", () => {
        ...
        it("shifts the token uri to lower when the price doesn't surpass the highvalue", async function () {
          const highValue = ethers.utils.parseEther("100000000"); // $100,000,000 dollar per ether. Maybe in the distant future this test will fail...(and I will be rich EZ)
      ...
      //Tests not covered: Checking for conversion to URI and other encoding related.
